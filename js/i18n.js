...
(function () {
  ...
  const translations = {
    fr: {
      ...
      "accom.double.alt1": "Terrasse privative du Bungalow Double, vue mer",
      "accom.double.alt2": "Coin salon de la terrasse privative, vue mer",
      ...
      "accom.double2.alt2": "Chambre Double, ambiance cosy",
      "accom.double2.alt3": "Terrasse privative de la chambre Double, vue mer",
      "accom.double2.alt4": "Coin salon de la terrasse, vue mer",
      ...
      "circuit.baobab.title": "Les Baobabs",
      "circuit.baobab.desc": "Une rencontre avec les baobabs multiséculaires du Nord, géants tranquilles du bush malgache.",
      "circuit.baobab.alt": "Baobabs multiséculaires du Nord de Madagascar",
      "circuit.montagnefrancais.title": "La Montagne des Français",
      "circuit.montagnefrancais.desc": "Randonnée entre forêt sèche et falaises calcaires, avec vue imprenable sur la baie de Diego-Suarez.",
      "circuit.montagnefrancais.alt": "Cascade et falaises de la Montagne des Français",
      "circuit.montagneambre.title": "La Montagne d'Ambre",
      "circuit.montagneambre.desc": "Forêt tropicale humide, cascades et lémuriens, au cœur du parc national.",
      "circuit.montagneambre.alt": "Forêt tropicale de la Montagne d'Ambre",
      "circuit.nosyhara.title": "Nosy Hara",
      "circuit.nosyhara.desc": "Un archipel préservé aux eaux turquoise, entre plages vierges et fonds marins protégés.",
      "circuit.nosyhara.alt": "Plage et falaises de Nosy Hara",
      "circuit.nosylonjo.title": "Nosy Lonjo",
      "circuit.nosylonjo.desc": "Un îlot rocheux emblématique planté dans le lagon, accessible en bateau.",
      "circuit.nosylonjo.alt": "Îlot rocheux de Nosy Lonjo",
      "circuit.quad.title": "Excursion en quad",
      "circuit.quad.desc": "Pistes de brousse et paysages sauvages du Nord, à parcourir en quad.",
      "circuit.quad.alt": "Excursion en quad dans le Nord de Madagascar",
      "circuit.phare.title": "Cap d'Ambre & le Phare",
      "circuit.phare.desc": "Le phare historique à la pointe nord de Madagascar, face à l'océan Indien.",
      "circuit.phare.alt": "Le phare du Cap d'Ambre",
    ...
    en: {
      ...
      "accom.double.alt1": "Private terrace of the Double Bungalow, sea view",
      "accom.double.alt2": "Lounge corner of the private terrace, sea view",
      ...
      "accom.double2.alt2": "Double room, cosy interior",
      "accom.double2.alt3": "Private terrace of the Double room, sea view",
      "accom.double2.alt4": "Terrace lounge corner, sea view",
      ...
      "circuit.baobab.title": "The Baobabs",
      "circuit.baobab.desc": "A meeting with centuries-old baobabs, quiet giants of the Malagasy bush.",
      "circuit.baobab.alt": "Centuries-old baobabs in northern Madagascar",
      "circuit.montagnefrancais.title": "Montagne des Français",
      "circuit.montagnefrancais.desc": "A hike through dry forest and limestone cliffs, with sweeping views over Diego-Suarez bay.",
      "circuit.montagnefrancais.alt": "Waterfall and cliffs at Montagne des Français",
      "circuit.montagneambre.title": "Montagne d'Ambre",
      "circuit.montagneambre.desc": "Rainforest, waterfalls and lemurs, deep inside the national park.",
      "circuit.montagneambre.alt": "Rainforest at Montagne d'Ambre",
      "circuit.nosyhara.title": "Nosy Hara",
      "circuit.nosyhara.desc": "A pristine archipelago of turquoise waters, untouched beaches and protected reefs.",
      "circuit.nosyhara.alt": "Beach and cliffs at Nosy Hara",
      "circuit.nosylonjo.title": "Nosy Lonjo",
      "circuit.nosylonjo.desc": "An iconic rock islet rising from the lagoon, reached by boat.",
      "circuit.nosylonjo.alt": "Rock islet of Nosy Lonjo",
      "circuit.quad.title": "Quad biking",
      "circuit.quad.desc": "Bush tracks and wild landscapes of the North, explored by quad bike.",
      "circuit.quad.alt": "Quad bike excursion in northern Madagascar",
      "circuit.phare.title": "Cap d'Ambre & the Lighthouse",
      "circuit.phare.desc": "The historic lighthouse at Madagascar's northern tip, facing the Indian Ocean.",
      "circuit.phare.alt": "The Cap d'Ambre lighthouse",
